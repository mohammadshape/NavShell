...
@NavDestinationDsl
class ModalComposeNavigatorDestinationBuilder :
    NavDestinationBuilder<ModalComposeNavigator.Destination> {

    private val composeNavigator: ModalComposeNavigator
    ...
    override fun instantiateDestination(): ModalComposeNavigator.Destination {
        return ModalComposeNavigator.Destination(composeNavigator, content)
    }

    override fun build(): ModalComposeNavigator.Destination {
